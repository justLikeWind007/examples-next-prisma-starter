...
-- CreateIndex
CREATE INDEX "Announcement_regionId_idx" ON "Announcement"("regionId");
...
-- AddForeignKey
ALTER TABLE "Announcement" ADD CONSTRAINT "Announcement_regionId_fkey" FOREIGN KEY ("regionId") REFERENCES "Region"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
